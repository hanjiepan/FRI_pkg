...
if __name__ == '__main__':
    ...
    markerline211_2, stemlines211_2, baseline211_2 = \
        plt.stem(tk_recon, ak_recon, label='Estimated Diracs', hold=True)
    ...
    # for web rendering
    if web_fig:
        output_file((r'./html/TSP_eg1_K_{0}_L_{1}_noise_{2}dB' +
                     time_stamp + '.html').format(repr(K), repr(L), repr(P)))
