...
if __name__ == '__main__':
    ...
    if periodic_spectrum:
        file_name = r'./data/freq_Dirac_Data_p' + time_stamp + r'.npz'
    else:
        file_name = r'./data/freq_Dirac_Data_ap' + time_stamp + r'.npz'
    np.savez(file_name, tk=tk, ak=ak, K=K, M=M)
    '''
    ...
    if periodic_spectrum:
        stored_param = np.load(r'./data/freq_Dirac_Data_p' + time_stamp + r'.npz')
    else:
        stored_param = np.load(r'./data/freq_Dirac_Data_ap' + time_stamp + r'.npz')
    tk = stored_param['tk']
    ak = stored_param['ak']
